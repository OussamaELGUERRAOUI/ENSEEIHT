	...
	class CButtonAction implements ActionListener {
		public void actionPerformed(ActionEvent ae) {
			...
			try {
	         ...
	         // Obtenir l'objet distant à partir du registre
	            Carnet carnet = (Carnet) registry.lookup("carnet");
	            
	            String emailR = carnet.Consulter(n, false).getEmail();
	            ...
	            if (emailR != null) {
	            	...
	            	System.out.println("non mail found");
	            }}
			 catch(Exception e) {
	            	e.printStackTrace();
	            }
		...
		public void actionPerformed(ActionEvent ae) {
			...
			try {
	         ...
	         // Obtenir l'objet distant à partir du registre
	            ...
	            SFiche sfiche = new SFicheImpl(n,e);
	            
	            carnet.Ajouter(sfiche);
			}
			catch(Exception ex) {
				ex.printStackTrace();
			}

...
public class PetrinetSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case PetrinetPackage.PETRI_NET_ELEMENT: {
				PetriNetElement petriNetElement = (PetriNetElement)theEObject;
				T result = casePetriNetElement(petriNetElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PetrinetPackage.NODE: {
				...
				if (result == null) result = casePetriNetElement(node);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PetrinetPackage.TRANSITION: {
				...
				if (result == null) result = casePetriNetElement(transition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PetrinetPackage.PLACE: {
				...
				if (result == null) result = casePetriNetElement(place);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PetrinetPackage.ARC: {
				...
				if (result == null) result = casePetriNetElement(arc);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Petri Net Element</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Petri Net Element</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T casePetriNetElement(PetriNetElement object) {
		return null;
	}

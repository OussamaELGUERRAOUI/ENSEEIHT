 ...
 *   <li>{@link simplepdl.WorkDefinition#getRessourceallocation <em>Ressourceallocation</em>}</li>
 * </ul>
 *
...
public interface WorkDefinition extends ProcessElement {
	...
	/**
	 * Returns the value of the '<em><b>Ressourceallocation</b></em>' containment reference list.
	 * The list contents are of type {@link simplepdl.RessourceAllocation}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Ressourceallocation</em>' containment reference list.
	 * @see simplepdl.SimplepdlPackage#getWorkDefinition_Ressourceallocation()

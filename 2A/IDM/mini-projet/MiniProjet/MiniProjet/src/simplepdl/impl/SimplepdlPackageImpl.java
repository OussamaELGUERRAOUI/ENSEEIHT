...
public class SimplepdlPackageImpl extends EPackageImpl implements SimplepdlPackage {
	 ...
	 */
	@Override
	public EReference getWorkDefinition_Ressourceallocation() {
	 ...
	 */
	@Override
	public EReference getGuidance_Processelement() {
	 ...
	 */
	@Override
	public EReference getRessource_Ressourceallocation() {
	 ...
	 */
	@Override
	public EAttribute getRessourceAllocation_Occurrence() {
	 ...
	 */
	@Override
	public EReference getRessourceAllocation_Workdefinition() {
		return (EReference)ressourceAllocationEClass.getEStructuralFeatures().get(2);
	}
	...
	public void createPackageContents() {
		...
		createEReference(processEClass, PROCESS__PROCESSELEMENT);
		...
		createEReference(workDefinitionEClass, WORK_DEFINITION__RESSOURCEALLOCATION);
		...
		createEReference(guidanceEClass, GUIDANCE__PROCESSELEMENT);
		...
		createEReference(ressourceEClass, RESSOURCE__RESSOURCEALLOCATION);

		ressourceAllocationEClass = createEClass(RESSOURCE_ALLOCATION);
		createEAttribute(ressourceAllocationEClass, RESSOURCE_ALLOCATION__OCCURRENCE);
		createEReference(ressourceAllocationEClass, RESSOURCE_ALLOCATION__RESSOURCE);
		createEReference(ressourceAllocationEClass, RESSOURCE_ALLOCATION__WORKDEFINITION);
	...
	public void initializePackageContents() {
		...
		initEReference(getWorkDefinition_Ressourceallocation(), this.getRessourceAllocation(), null, "ressourceallocation", null, 0, -1, WorkDefinition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getGuidance_Processelement(), this.getProcessElement(), null, "processelement", null, 0, 1, Guidance.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getRessource_Ressourceallocation(), this.getRessourceAllocation(), null, "ressourceallocation", null, 0, -1, Ressource.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getRessourceAllocation_Occurrence(), ecorePackage.getEInt(), "occurrence", null, 0, 1, RessourceAllocation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getRessourceAllocation_Workdefinition(), this.getWorkDefinition(), null, "workdefinition", null, 1, 1, RessourceAllocation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

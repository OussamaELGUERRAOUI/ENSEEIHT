 ...
 *   <li>{@link simplepdl.impl.WorkDefinitionImpl#getRessourceallocation <em>Ressourceallocation</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WorkDefinitionImpl extends ProcessElementImpl implements WorkDefinition {
	...
	/**
	 * The cached value of the '{@link #getRessourceallocation() <em>Ressourceallocation</em>}' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public EList<RessourceAllocation> getRessourceallocation() {
		if (ressourceallocation == null) {
			ressourceallocation = new EObjectContainmentEList<RessourceAllocation>(RessourceAllocation.class, this, SimplepdlPackage.WORK_DEFINITION__RESSOURCEALLOCATION);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case SimplepdlPackage.WORK_DEFINITION__RESSOURCEALLOCATION:
				return ((InternalEList<?>)getRessourceallocation()).basicRemove(otherEnd, msgs);
		}

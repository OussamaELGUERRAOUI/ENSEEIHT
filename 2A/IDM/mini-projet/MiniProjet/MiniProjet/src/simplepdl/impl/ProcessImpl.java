 ...
 *   <li>{@link simplepdl.impl.ProcessImpl#getProcesselement <em>Processelement</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ProcessImpl extends MinimalEObjectImpl.Container implements simplepdl.Process {
	...
	/**
	 * The cached value of the '{@link #getProcesselement() <em>Processelement</em>}' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public EList<ProcessElement> getProcesselement() {
		if (processelement == null) {
			processelement = new EObjectContainmentEList<ProcessElement>(ProcessElement.class, this, SimplepdlPackage.PROCESS__PROCESSELEMENT);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SimplepdlPackage.PROCESS__PROCESSELEMENT:

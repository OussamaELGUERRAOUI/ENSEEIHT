...
public interface SimplepdlPackage extends EPackage {
	...
	/**
	 * The feature id for the '<em><b>Ressourceallocation</b></em>' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int WORK_DEFINITION__RESSOURCEALLOCATION = PROCESS_ELEMENT_FEATURE_COUNT + 3;
	...
	/**
	 * The feature id for the '<em><b>Processelement</b></em>' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int GUIDANCE__PROCESSELEMENT = PROCESS_ELEMENT_FEATURE_COUNT + 1;
	...
	/**
	 * The feature id for the '<em><b>Ressourceallocation</b></em>' reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int RESSOURCE__RESSOURCEALLOCATION = PROCESS_ELEMENT_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int RESSOURCE_ALLOCATION__OCCURRENCE = 0;
	 ...
	 * @ordered
	 */
	int RESSOURCE_ALLOCATION__WORKDEFINITION = 2;
	...
	/**
	 * Returns the meta object for the containment reference list '{@link simplepdl.WorkDefinition#getRessourceallocation <em>Ressourceallocation</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Ressourceallocation</em>'.
	 * @see simplepdl.WorkDefinition#getRessourceallocation()
	 * @see #getWorkDefinition()
	 * @generated
	 */
	EReference getWorkDefinition_Ressourceallocation();
	...
	/**
	 * Returns the meta object for the reference '{@link simplepdl.Guidance#getProcesselement <em>Processelement</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Processelement</em>'.
	 * @see simplepdl.Guidance#getProcesselement()
	 * @see #getGuidance()
	 * @generated
	 */
	EReference getGuidance_Processelement();
	...
	/**
	 * Returns the meta object for the reference list '{@link simplepdl.Ressource#getRessourceallocation <em>Ressourceallocation</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference list '<em>Ressourceallocation</em>'.
	 * @see simplepdl.Ressource#getRessourceallocation()
	 * @see #getRessource()
	 * @generated
	 */
	EReference getRessource_Ressourceallocation();
	...
	/**
	 * Returns the meta object for the attribute '{@link simplepdl.RessourceAllocation#getOccurrence <em>Occurrence</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Occurrence</em>'.
	 * @see simplepdl.RessourceAllocation#getOccurrence()
	 * @see #getRessourceAllocation()
	 * @generated
	 */
	EAttribute getRessourceAllocation_Occurrence();
	...
	/**
	 * Returns the meta object for the reference '{@link simplepdl.RessourceAllocation#getWorkdefinition <em>Workdefinition</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Workdefinition</em>'.
	 * @see simplepdl.RessourceAllocation#getWorkdefinition()
	 * @see #getRessourceAllocation()
	 * @generated
	 */
	EReference getRessourceAllocation_Workdefinition();
	...
	interface Literals {
		...
		/**
		 * The meta object literal for the '<em><b>Ressourceallocation</b></em>' containment reference list feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference WORK_DEFINITION__RESSOURCEALLOCATION = eINSTANCE.getWorkDefinition_Ressourceallocation();
		...
		/**
		 * The meta object literal for the '<em><b>Processelement</b></em>' reference feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference GUIDANCE__PROCESSELEMENT = eINSTANCE.getGuidance_Processelement();
		...
		/**
		 * The meta object literal for the '<em><b>Ressourceallocation</b></em>' reference list feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference RESSOURCE__RESSOURCEALLOCATION = eINSTANCE.getRessource_Ressourceallocation();
		 ...
		 * @generated
		 */
		EAttribute RESSOURCE_ALLOCATION__OCCURRENCE = eINSTANCE.getRessourceAllocation_Occurrence();
		 ...
		 * @generated
		 */
		EReference RESSOURCE_ALLOCATION__WORKDEFINITION = eINSTANCE.getRessourceAllocation_Workdefinition();

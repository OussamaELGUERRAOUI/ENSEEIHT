...
let rec insert ordre elt l = 
  match l with
  | [] -> [elt]
  | h::t -> if ordre elt h then elt::l else h::(insert ordre elt t)

(* TESTS *)
let test1 = insert (fun x y -> x<y) 3 []=[3]
let test2  = insert (fun x y -> x<y) 3 [2;4;5]=[2;3;4;5]
let test3 = insert (fun x y -> x > y) 6 [3;2;1]=[6;3;2;1]
...
(* TESTS *)
let test1 = tri_insertion (fun x y -> x<y) [] =[]
let test2 = tri_insertion (fun x y -> x<y) [4;2;4;3;1] =[1;2;3;4;4]
let test3 = tri_insertion (fun x y -> x > y) [4;7;2;4;1;2;2;7]=[7;7;4;4;2;2;2;1]
...
let rec scinde l = 
  ...
  | [] -> ([],[])
  | [x] -> ([x],[])
  | t1 :: t2 :: q -> let (l1,l2) = scinde q 
    in (t1::l1,t2::l2)
(* TESTS *)
(* Peuvent être modifiés selon l'algorithme choisi *)
let test1 = scinde [1;2;3;4] = ([1;3],[2;4])
...
(*TESTS*)
let test1 = fusionne (fun x y -> x<y) [1;2;4;5;6] [3;4] = [1;2;3;4;4;5;6]
let test2 = fusionne (fun x y -> x<y) [1;2;4] [3;4] = [1;2;3;4;4]
let test3 = fusionne (fun x y -> x<y) [1;2;4] [3;4;8;9;10] = [1;2;3;4;4;8;9;10]
let test4 = fusionne (fun x y -> x<y) [] [] = []
let test5 = fusionne (fun x y -> x<y) [1] [] = [1]
let test6 = fusionne (fun x y -> x<y) [] [1] = [1]
let test7 = fusionne (fun x y -> x<y) [1] [2] = [1;2]
let test8 = fusionne (fun x y -> x>y) [1] [2] = [2;1]
...
(* TESTS *)
let test1 = tri_fusion (fun x y -> x<y) [] =[]
let test2 = tri_fusion (fun x y -> x<y) [4;2;4;3;1] =[1;2;3;4;4]
let test3 = tri_fusion (fun x y -> x > y) [4;7;2;4;1;2;2;7]=[7;7;4;4;2;2;2;1]
...
*)
let listStat = 
  let input = open_in "C:/Users/elgue/OneDrive/Bureau/SN/2SN/S7/programmation fonctionnel/tp/TP2/sourceEtu/nat2016.txt" in 
...
*)
let listStatHomme = 
  let input = open_in "C:/Users/elgue/OneDrive/Bureau/SN/2SN/S7/programmation fonctionnel/tp/TP2/sourceEtu/nathomme2016.txt" in
  let filebuf = Lexing.from_channel input in
  Parser.main Lexer.token filebuf

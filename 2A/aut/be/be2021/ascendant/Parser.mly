...
boucleModel : /* mot vide */ { (print_endline "sous_modele : /* mot vide */ ") }
            | bloc boucleModel { (print_endline "sous_modele : sous_modele { sous_modele } ") }
            | systeme boucleModel { (print_endline "sous_modele : sous_modele { sous_modele } ") }
            | flot boucleModel { (print_endline "sous_modele : sous_modele { sous_modele } ") }
